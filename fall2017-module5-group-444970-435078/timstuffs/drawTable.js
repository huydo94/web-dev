    ...
    if(tagSelect !== undefined) {
        ...
        xmlHttp.addEventListener("load", function(event) {
          ...
          for (var i=0; i<jsonData.length;i++) {
            ...
            event1datetime.appendChild(document.createTextNode(eventdata["datetimeofevent"].substring(11,16)));
            var event1title = document.createElement("b");
            event1title.appendChild(document.createTextNode(eventdata["title"]));
...
$(function() { //shorthand document.ready function
    $('#newEventForm').on('submit', function(e) { //use on if jQuery 1.7+
        ...
        var dataString = "title=" + encodeURIComponent(addTitle) + "&dateofevent=" + encodeURIComponent(addDateofevent) + "&datetimeofevent=" + encodeURIComponent(addDatetimeofevent) + "&tag=" + encodeURIComponent(addTag);
